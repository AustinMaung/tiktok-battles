...
function App() {
	...
	useEffect(() => {
		async function fetchData() {
			const response = await fetch('http://localhost:3000/get-amount', {
				method: 'GET',
				headers: {
	...
	async function loadVoting() {
	    ...
	    const response1 = await fetch('http://localhost:3000/get-random', {
	        method: 'GET',
	        headers: {
	            'Content-Type': 'application/json',
	        }
	    ...
	    const response2 = await fetch('http://localhost:3000/get-random', {
	        method: 'GET',
	        headers: {
	            'Content-Type': 'application/json',
	        }
...
// 	function createEmbed(parsedURL) {
// 		setShow(true)
// 		resetVideos()
// 		console.log(parsedURL)
...
// 		const parentDiv = document.getElementById('videos')
// 		parentDiv.appendChild(div)
// 		ReactDOM.render(<TikTokEmbed url={parsedURL.url} videoID={parsedURL.videoID} />, div);
// 		div.className = 'content'
...
// 	}
	...
	//     });
	//     const data1 = await response1.json();
	//     const parsedURL1 = parseTikTokURL(data1);
	//     createEmbed(parsedURL1);

	//     // Make the second API request to get another random URL
	//     const response2 = await fetch('http://localhost:3000/get-random', {
	//         method: 'GET',
	//         headers: {
	//             'Content-Type': 'application/json',
	...
	//     });
	//     const data2 = await response2.json();
	//     const parsedURL2 = parseTikTokURL(data2);
	//     createEmbed(parsedURL2);
	// }

// 	async function handleSubmit(parsedURL) {
// 		createEmbed(1, parsedURL)
// 		const button = document.createElement('button')
// 		button.textContent = 'Back'
// 		document.getElementById('buttons').appendChild(button)
